...
const navItems: NavItem[] = [
  ...
  },
  {
    name: "Services",
    icon: <ListIcon />,
    subItems: [{ name: "Service catalogue", path: "/form-elements", pro: false }],
  },
  {
    name: "Customers",
    icon: <TableIcon />,
    subItems: [{ name: "Customer directory", path: "/basic-tables", pro: false }],
  },
  {
    name: "Locations",
    icon: <PageIcon />,
    subItems: [
      { name: "Branches & rooms", path: "/blank", pro: false },
    ],
  },
];
