...
export default function SignInForm() {
  ...
  const [email, setEmail] = useState("owner@spaelaris.com");
  ...
  return (
    <div className="flex flex-col flex-1 lg:w-1/2 w-full">
      <div className="w-full max-w-md sm:pt-10 mx-auto mb-[-120px]">
        <Link
          href="/"
        ...
        <div>
          ...
          <div className="mb-5 sm:mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Enter your email and password to access the Spaelaris admin.
            </p>
          </div>
          <div>
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input
                    placeholder="owner@spaelaris.com"
                    type="email"
                    value={email}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    href="/reset-password"
                    className="text-sm text-[#536238]-500 hover:text-[#536238]-600 dark:text-[#536238]-400"
                  >
                    Forgot password?
                  </Link>
                </div>
